...
const placeholders = [
  { title: "Visual Documentary", role: "Production Lead", img: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=800", accent: "#16a34a" },
  { title: "Brand Narrative", role: "Visual Storytelling", img: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?q=80&w=800", accent: "#facc15" },
  { title: "Creative Direction", role: "Photography", img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=800", accent: "#e67e22" },
  { title: "Corporate Events", role: "Event Coverage", img: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=800", accent: "#16a34a" },
  { title: "Portrait Series", role: "Photography", img: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?q=80&w=800", accent: "#facc15" },
  { title: "Cultural Stories", role: "Documentary", img: "https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?q=80&w=800", accent: "#e67e22" },
];
                ...
                return (
                  <div key={cat.id} className="project-card">
                    <div style={{ height: "200px", overflow: "hidden", backgroundColor: "#3d2325" }}>
                      {cat.images[0] && (
                        <img src={cat.images[0].thumbnailUrl} alt={cat.title} className="project-img" />
                      )}
                    </div>
